              ...
              .column.is-6
                div.box
                  ...
                  .field
                    .field
                      label Campo 1
                      input.input.is-fullwidth(type='text', v-model='nuevo_contrato.campo_1')
                    .field
                      label Campo 2
                      input.input.is-fullwidth(type='text', v-model='nuevo_contrato.campo_2')
                    .field
                      label Campo 3
                      .select.is-fullwidth
                        select(v-model='nuevo_contrato.campo_3')
                          option(value='')
                    ...
                    .field
                      label Campo 4
                      input.input.is-fullwidth(type="date", v-model='nuevo_contrato.campo_4')

                  .field.is-grouped
                    button.button.is-primary.is-small(
                        @click.prevent="guardar_contrato()"
                    ) Guardar Contrato
