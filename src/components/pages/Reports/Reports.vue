<template lang="pug">
  div
    .section.hero.is-info.is-small.is-bold(v-show="isVisibleOptionsBanner==true")
      ...
      .hero-body
        //.has-text-centered
        h5.title Más opciones · Módulo de Reportes y Descargas
        h6 Invercol IO
...
export default {
  ...
  data() {
    return {
        ...
        localInstanceNameDetail:'Reportes', // nombre de la instancia local por la page que hace ref. a hoteles -> hotel o a $data[this.localInstanceName]
